...
export const tabilens = {
  id: 'tabilens',
  title: 'TabiLenS',
  subtitle: '실시간 다국어 메뉴판 번역 및 주문 도우미 서비스',
  author: 'Joohyoung Yi',
    ...
    results: [
      {
        ...
        figs: [tabilens_1],
        captions: ['그림 1: 맞춤형 번역 및 식문화 가이드를 설정하는 국가 선택 화면']
      },
      {
        title: '카메라 스캔 및 이미지 불러오기',
        desc: '일본어 메뉴판 번역을 위해 모바일 카메라로 직접 촬영하거나 기기에 저장된 갤러리 이미지에서 사진을 선택하여 텍스트 분석을 요청할 수 있는 기능입니다.',
        figs: [tabilens_2],
        captions: ['그림 2: 실시간 카메라 스캔 및 갤러리 이미지 불러오기를 지원하는 스캐너 대시보드']
      },
      {
        title: '식문화 해설 및 주문 도우미 결과 화면',
        ...
        figs: [tabilens_3],
        captions: ['그림 3: 식문화 맥락 해설, 식재료/알레르기 분석 및 TTS 음성 주문 지원 화면']
      }
    ],
